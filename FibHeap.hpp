...
void FibHeap::link(Node* n1, Node *n2, bool zameni){
    ...
    cout << '\n';
    /**/
    if (!(n1->next == n2 || n1->prev == n2 || n2->next == n1 || n2->prev == n1) && zameni) {
        Node* n1prev = n1->prev;
        Node* n1next = n1->next;
    ...
    n1->child = n2;
    n1->degree++; //Broj potomaka => direktnih ili ukupno? Ostavljam ovako gde je to broj direktnih potomaka
}
